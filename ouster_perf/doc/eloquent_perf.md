Ouster LiDAR Performance in ROS2 - Eloquent
===========================================
This document covers the jitter and latency analysis that was conducted using
ROS2 Eloquent with an OS1-16 LiDAR.
